...
![Platforms](https://img.shields.io/badge/platforms-macOS%20%7C%20iOS%20%7C%20Android%20%7C%20Windows%20%7C%20Linux%20%7C%20Web-blue)
...
- **Cross-platform** — one Flutter codebase runs on macOS, iOS, Android, Windows, Linux, and Web
...
│  • Client-side AES-256-GCM  │   WSS  │  • WebSocket SSH bridge      │
│    encryption               │◄──────►│  • PostgreSQL via Prisma     │
...
| Server | Node.js 18, TypeScript, Express 5 |
...
└── server/                   # Node.js API
    ├── src/
    │   ├── index.ts          # Express app + WebSocket SSH bridge
...
- **WebSocket auth** — token passed via `Sec-WebSocket-Protocol` header (not query string)
